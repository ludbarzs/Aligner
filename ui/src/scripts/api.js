...
import { applyCSSTransformations } from "./image-utils.js";
...
export async function sendToAPI() {
  ...
  try {
    // Apply CSS transformations before sending
    const { transformedImage, transformedCoords } = applyCSSTransformations(
